...
class Equipo {
    ...
    public void agregarJugador(Jugador jugador) {
        if (jugador == null || !jugador.getCategoria().equals(this.categoria)
                || !jugador.getGenero().equalsIgnoreCase(this.modalidad))
            return;
    ...
    public String toString() {
        return "Equipo [nombre=" + nombre + ", categoria=" + categoria + ", modalidad=" + modalidad
                + ", entrenador=" + entrenador + ", segundoEntrenador=" + segundoEntrenador + ", jugadores="
                + jugadores + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return nombre.equals(other.nombre) && categoria.equals(other.categoria) && modalidad.equals(other.modalidad);
    }
}
